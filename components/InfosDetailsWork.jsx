...
const InfosDetailsWork = ({ image, containerRef }) => {
...
--------------------*/
  ...
  return (
    <div
      ref={infosContentRef}
      className="absolute bottom-0 left-0 transform  h-screen w-[35%] px-10 py-20 flex flex-col  bg-white "
    >
      <div>
...
export default InfosDetailsWork;
